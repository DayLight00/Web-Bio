...
<nav class="w3-sidebar w3-black w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <a target="_blank" href="uitm.png">
    <img src="uitm.png" alt="uitm" width="230" height="180">
  </a>
    <h3 class="w3-padding-64 w3-black"><b>UiTM Machang</b></h3>
  </div>
...
<div class="w3-container center" style="margin-top:80px;margin-left:250px" id="showcase">
    <center><h1 class="w3-xxxlarge w3-text-black"><b>UiTM Machang</b></h1></center>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    ...
    <p>UiTM Kelantan Branch (UiTMCK) is one of the branches of Universiti Teknologi MARA located in the state of Kelantan Darul Naim. It was established in July 1985 as the ninth UiTM branch campus in a temporary location near Kota Bharu. Currently, the UiTM Kelantan branch campus is at its permanent location in Machang after moving in January 1996.</p>
