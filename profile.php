...
<nav class="w3-sidebar w3-black w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <a target="_blank" href="din.jpeg">
    <img src="din.jpeg" alt="Palestian Flag" width="230" height="180">
  </a>
    <h3 class="w3-padding-64 w3-black"><b>Palestine</b></h3>
  </div>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-col m4 w3-margin-bottom">
      ...
      <a target="_blank" href="din.jpeg">
    <img src="din.jpeg" alt="Malaysian" width="450px" height="350px" >
  </a>
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-black"><b>About</b></h1>
    <hr style="width:50px;border:5px solid black" class="w3-round">
    <p>Name : Abdullah Mahyuddin</p>
    <p>No. Matric : 2020981031</p>
    <p>Info : A student of Information Technology in Computer Science. Study at UiTM Campus Machang Kelantan</p>
