...
<nav class="w3-sidebar w3-black w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <a target="_blank" href="uitm.png">
    ...
    <h3 class="w3-padding-64 w3-black"><b>UiTM</b></h3>
  </div>
...
<div class="w3-container center" style="margin-top:80px;margin-left:450px" id="showcase">
    <h1 class="w3-xxxlarge w3-text-black"><b>UiTM</b></h1>
    <hr style="width:50px;margin-left:30px;border:5px solid black" class="w3-round">
  </div>
</div>
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    ...
    <p>Universiti Teknologi MARA (literally MARA University of Technology, abbreviated as UiTM) is a public university based primarily in Shah Alam. It was established to help rural Malays in 1956 as the RIDA (Rural & Industrial Development Authority) Training Centre (Malay: Dewan Latihan RIDA), and opened with around 50 students. It has since grown into the largest institution of higher education in Malaysia as measured by physical infrastructure, faculty and staff, and student enrollment.</p>
